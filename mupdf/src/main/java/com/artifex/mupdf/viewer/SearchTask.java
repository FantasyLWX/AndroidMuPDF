			...
			protected void onPostExecute(SearchTaskResult result) {
				...
				if (result != null) {
					...
					//mAlertBuilder.setTitle(SearchTaskResult.get() == null ? 
						//	R.string.text_not_found : R.string.no_further_occurrences_found);
					String message = SearchTaskResult.get() == null
							? mContext.getString(R.string.text_not_found)
							: mContext.getString(R.string.no_further_occurrences_found);
